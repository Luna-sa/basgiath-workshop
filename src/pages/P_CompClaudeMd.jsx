...
- Never modify the production fixtures dataset.`,
  when: [
    {
      en: 'Every project, day one. The single highest-leverage file in Claude Code.',
      ru: 'Каждый проект, день первый. Самый высокорычажный файл в Claude Code.',
      uk: 'Кожен проєкт, день перший. Найважливіший файл у Claude Code.',
    },
    {

        ...
        <div>
          ...
          <p className="text-[15px] text-text-body leading-relaxed">
            {t(
              ...
              'Сім коротких питань — луска, подих, сигнет, розмір, крила, очі, девіз. За відповідями генерується справжній кінематографічний портрет. Можеш перегенерувати поки не відчуєш — це він. Запечатаєш — він потрапляє в Аерію поряд з усіма іншими.'
            )}
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="border border-qa-teal/30 bg-qa-teal/[0.04] p-5">
            ...
            <ul className="text-[13.5px] text-text-body leading-relaxed space-y-1.5 list-none">
              <li>1. {t('Answer seven visual questions (voice or typing).', 'Ответь на семь визуальных вопросов (голос или текст).', 'Відповідай на сім візуальних питань (голос або текст).')}</li>
              ...
              <li>4. {t('Re-roll until it feels right. No limit on attempts.', 'Перегенерь пока не почувствуешь. Лимита на попытки нет.', 'Перегенеруй поки не відчуєш. Ліміту на спроби немає.')}</li>

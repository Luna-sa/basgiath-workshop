...
can reproduce the bug from your report alone.`,
  when: [
    {
      en: 'Any workflow you run twice a week — fossilise it as a command. The cost is 5 minutes; the saving is every future run.',
      ru: 'Любой workflow что запускаешь дважды в неделю - зафиксируй командой. Цена - 5 минут; экономия - каждый будущий запуск.',
      uk: 'Будь-який workflow, що запускаєш двічі на тиждень - зафіксуй командою. Ціна - 5 хвилин; економія - кожен майбутній запуск.',
    },
    {

...
export const GEMS = [
  {
    ...
    name: 'MemPalace',
    heroImage: asset('/hero/gem-mempalace.jpg'),
...
6. Напомни перезапустить Claude Code чтобы MCP подхватился.`,
...

  {
    ...
    name: 'suzu-mcp',
    heroImage: asset('/hero/gem-suzu.jpg'),
...
5. Тест: попроси Claude «list 3 files» и посмотри играет ли Spotify`,
...

  {
    ...
    heroImage: asset('/hero/gem-toolsearch.jpg'),
...
впасти (8-15k токенів замість 77k+).`,
...

  {
    ...
    heroImage: asset('/hero/gem-quinn-jinx.jpg'),
...
export const GEM_CATEGORIES = [
  // ── 1. DESIGN SKILLS ───────────────────────────────────────────
  {
    ...
    heroImage: asset('/hero/gem-design-dna.jpg'),
    intro_en: 'AI writes generic UI by default - same purple gradients, same boxy cards, same forgettable typography. These three skills give Claude actual design taste: how to extract a design DNA from any URL, how to fix the most common AI mistakes one click at a time, and how to run a full local design studio.',
    intro_ru: 'AI по дефолту пишет generic UI - те же фиолетовые градиенты, те же кубические карточки, та же забываемая типографика. Три skills ниже дают Claude настоящий дизайнерский вкус: вытащить design DNA с любого URL, починить типовые AI-ошибки в один клик, и запустить целую дизайн-студию локально.',
    intro_uk: 'AI за замовчуванням пише generic UI - ті ж фіолетові градієнти, ті ж кубічні картки, та ж забутна типографіка. Три skills нижче дають Claude справжній дизайнерський смак: витягти design DNA з будь-якого URL, полагодити типові AI-помилки за один клік, і запустити цілу дизайн-студію локально.',
    items: [
      {
        name: 'design-extract',
        image: '/repos/design-extract.png',
        author: 'Manavarya09',
        stars: '2k',
  ...
  // ── 2. BROWSER AUTOMATION ──────────────────────────────────────
  {
    ...
    heroImage: asset('/hero/gem-sky-scribes.jpg'),
    ...
    items: [
      ...
      },
      {
        ...
        image: '/repos/browser-harness.png',
        author: 'browser-use',
        stars: '10k',
  ...
  // ── 3. SMART HELPERS ───────────────────────────────────────────
  {
    ...
    heroImage: asset('/hero/gem-wing-hands.jpg'),
    ...
    items: [
      {
        ...
        image: '/repos/understand-anything.png',
        author: 'Lum1104',
        stars: '10.5k',
  ...
  // ── 4. SKILLS MARKETPLACE ──────────────────────────────────────
  {
    ...
    heroImage: asset('/hero/gem-forge-market.jpg'),
    intro_en: 'Skills are reusable instruction bundles Claude can load on demand - like plugins, but author-friendly markdown. Once you understand the shape, you stop building everything from scratch. Below is the map: the community-curated directory, the superpowers meta-framework, and the awesome-list that tracks everything Claude-Code adjacent.',
    intro_ru: 'Skills - переиспользуемые instruction-bundle которые Claude может подключать on demand - как плагины, но author-friendly markdown. Когда понимаешь форму - перестаёшь писать всё с нуля. Ниже карта: community-директория, superpowers meta-framework и awesome-list со всем что около Claude Code.',
    intro_uk: 'Skills - перевикористовувані instruction-bundle які Claude може підключати on demand - як плагіни, але author-friendly markdown. Коли розумієш форму - перестаєш писати все з нуля. Нижче карта: community-директорія, superpowers meta-framework та awesome-list з усім, що навколо Claude Code.',
    items: [
      {
        name: 'skills.sh',
        image: '/repos/skills-sh.png',
      ...
      },
      {
        ...
        image: '/repos/awesome-claude-code.png',

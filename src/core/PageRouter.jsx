...
const pageComponents = {
  ...
  6: lazy(() => import('../pages/P_CompClaudeMd')),
  7: lazy(() => import('../pages/P_CompCommands')),
  8: lazy(() => import('../pages/P_CompAgents')),
  9: lazy(() => import('../pages/P_CompSkills')),
  10: lazy(() => import('../pages/P_CompMCP')),
  11: lazy(() => import('../pages/P_CompHooks')),
  12: lazy(() => import('../pages/P_CompPlugins')),
  13: lazy(() => import('../pages/P_TalkModes')),
  14: lazy(() => import('../pages/P06_InstallEcosystem')),
  15: lazy(() => import('../pages/P07_TalkEcosystem')),
  16: lazy(() => import('../pages/P10_TalkMCP')),
  17: lazy(() => import('../pages/P_TalkPowerMoves')),
  18: lazy(() => import('../pages/P_PersonaIntro')),
  19: lazy(() => import('../pages/P_BondIntro')),
  20: lazy(() => import('../pages/P_HiddenGems')),
  21: lazy(() => import('../pages/P_GemMemPalace')),
  22: lazy(() => import('../pages/P_GemSuzuMcp')),
  23: lazy(() => import('../pages/P_GemToolSearch')),
  24: lazy(() => import('../pages/P_GemQuinnJinx')),
  25: lazy(() => import('../pages/P_GemChannels')),
  26: lazy(() => import('../pages/P_GemDesignSkills')),
  27: lazy(() => import('../pages/P_GemBrowserAutomation')),
  28: lazy(() => import('../pages/P_GemSmartHelpers')),
  29: lazy(() => import('../pages/P_GemSkillsMarketplace')),
  30: lazy(() => import('../pages/P_AerieIntro')),
  31: lazy(() => import('../pages/P_ArenaIntro')),
  32: lazy(() => import('../pages/P14_Leaderboard')),
  33: lazy(() => import('../pages/P_Champions')),
  34: lazy(() => import('../pages/P15_Graduation')),
  35: lazy(() => import('../pages/P_ResourcesIntro')),
}

...
const pageComponents = {
  ...
  19: lazy(() => import('../pages/P_HiddenGems')),
  20: lazy(() => import('../pages/P_GemMemPalace')),
  21: lazy(() => import('../pages/P_GemSuzuMcp')),
  22: lazy(() => import('../pages/P_GemToolSearch')),
  23: lazy(() => import('../pages/P_GemQuinnJinx')),
  24: lazy(() => import('../pages/P_GemChannels')),
  ...
  29: lazy(() => import('../pages/P_AerieIntro')),
  30: lazy(() => import('../pages/P_ArenaIntro')),
  31: lazy(() => import('../pages/P14_Leaderboard')),
  32: lazy(() => import('../pages/P_Champions')),
  33: lazy(() => import('../pages/P15_Graduation')),
  34: lazy(() => import('../pages/P_ResourcesIntro')),
}
